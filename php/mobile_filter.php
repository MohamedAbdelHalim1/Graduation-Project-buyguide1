...
$low = $high =  $mobile_brand = $mobile_color = $b_low = $b_high =$mobile_RAM = $mobile_STORAGE  = $gov = "";
...
if (isset($_POST["brand"]) && isset($_POST["price"]) && isset($_POST["color"]) && isset($_POST["battery"]) && isset($_POST["ram"]) && isset($_POST["storage"])) {
  ...
  INNER JOIN stores_address sa ON sa.branch_id = ep.store_branch_id  WHERE sub_id = 1 AND brand = '$mobile_brand' AND price BETWEEN $low AND $high AND color = '$mobile_color' AND battery BETWEEN $b_low AND $b_high AND ram = $mobile_RAM AND storage = $mobile_STORAGE";
}
...
if (isset($_POST["brand"]) && isset($_POST["price"]) && isset($_POST["color"]) && isset($_POST["battery"]) && isset($_POST["ram"]) && $_POST["storage"]==NULL) {
  $sql = "SELECT * FROM electronic_products e INNER JOIN electronic_products_stores ep 
  ON e.e_id = ep.electronics_products_id
  INNER JOIN stores_address sa ON sa.branch_id = ep.store_branch_id WHERE sub_id = 1 AND brand = '$mobile_brand' AND price BETWEEN $low AND $high AND color = '$mobile_color' AND battery BETWEEN $b_low AND $b_high AND ram = $mobile_RAM";
}
...
if (isset($_POST["brand"]) && isset($_POST["price"]) && isset($_POST["color"]) && isset($_POST["battery"]) && $_POST["ram"]==NULL && isset($_POST["storage"])) {
  $sql = "SELECT * FROM electronic_products e INNER JOIN electronic_products_stores ep 
  ON e.e_id = ep.electronics_products_id
  INNER JOIN stores_address sa ON sa.branch_id = ep.store_branch_id WHERE sub_id = 1 AND brand = '$mobile_brand' AND price BETWEEN '$low' AND '$high' AND color = '$mobile_color' AND battery BETWEEN '$b_low' AND '$b_high' AND storage = '$mobile_STORAGE'";
}
...
if (isset($_POST["brand"]) && isset($_POST["price"]) && isset($_POST["color"]) && $_POST["battery"]==NULL && isset($_POST["ram"]) && isset($_POST["storage"])) {
  $sql = "SELECT * FROM electronic_products e INNER JOIN electronic_products_stores ep 
  ON e.e_id = ep.electronics_products_id
  INNER JOIN stores_address sa ON sa.branch_id = ep.store_branch_id WHERE sub_id = 1 AND brand = '$mobile_brand' AND price BETWEEN '$low' AND '$high' AND color = '$mobile_color' AND ram = '$mobile_RAM' AND storage = '$mobile_STORAGE'";
}
...
if (isset($_POST["brand"]) && isset($_POST["price"]) && $_POST["color"]==NULL && isset($_POST["battery"]) && isset($_POST["ram"]) && isset($_POST["storage"])) {
  $sql = "SELECT * FROM electronic_products e INNER JOIN electronic_products_stores ep 
  ON e.e_id = ep.electronics_products_id
  INNER JOIN stores_address sa ON sa.branch_id = ep.store_branch_id WHERE sub_id = 1 AND brand = '$mobile_brand' AND price BETWEEN '$low' AND '$high' AND battery BETWEEN '$b_low' AND '$b_high' AND ram = '$mobile_RAM' AND storage = '$mobile_STORAGE'";
}
...
if (isset($_POST["brand"]) && $_POST["price"]==NULL && isset($_POST["color"]) && isset($_POST["battery"]) && isset($_POST["ram"]) && isset($_POST["storage"])) {
  $sql = "SELECT * FROM electronic_products e INNER JOIN electronic_products_stores ep 
  ON e.e_id = ep.electronics_products_id
  INNER JOIN stores_address sa ON sa.branch_id = ep.store_branch_id WHERE sub_id = 1 AND brand = '$mobile_brand' AND color = '$mobile_color' AND battery BETWEEN '$b_low' AND '$b_high' AND ram = '$mobile_RAM' AND storage = '$mobile_STORAGE'";
}
...
if ($_POST["brand"]==NULL && isset($_POST["price"]) && isset($_POST["color"]) && isset($_POST["battery"]) && isset($_POST["ram"]) && isset($_POST["storage"])) {
  $sql = "SELECT * FROM electronic_products e INNER JOIN electronic_products_stores ep 
  ON e.e_id = ep.electronics_products_id
  INNER JOIN stores_address sa ON sa.branch_id = ep.store_branch_id WHERE sub_id = 1 AND price BETWEEN '$low' AND '$high' AND color = '$mobile_color' AND battery BETWEEN '$b_low' AND '$b_high' AND ram = '$mobile_RAM' AND storage = '$mobile_STORAGE'";
}
...
if (isset($_POST["brand"]) && isset($_POST["price"]) && isset($_POST["color"]) && isset($_POST["battery"]) && $_POST["ram"]==NULL && $_POST["storage"]==NULL) {
  $sql = "SELECT * FROM electronic_products e INNER JOIN electronic_products_stores ep 
  ON e.e_id = ep.electronics_products_id
  INNER JOIN stores_address sa ON sa.branch_id = ep.store_branch_id WHERE sub_id = 1 AND brand = '$mobile_brand' AND price BETWEEN '$low' AND '$high' AND color = '$mobile_color' AND battery BETWEEN '$b_low' AND '$b_high'";
}
...
if (isset($_POST["brand"]) && isset($_POST["price"]) && isset($_POST["color"]) && $_POST["battery"]==NULL && isset($_POST["ram"]) && $_POST["storage"]==NULL ) {
  $sql = "SELECT * FROM electronic_products e INNER JOIN electronic_products_stores ep 
  ON e.e_id = ep.electronics_products_id
  INNER JOIN stores_address sa ON sa.branch_id = ep.store_branch_id WHERE sub_id = 1 AND brand = '$mobile_brand' AND price BETWEEN '$low' AND '$high' AND color = '$mobile_color' AND ram = '$mobile_RAM'";
}
...
if (isset($_POST["brand"]) && isset($_POST["price"]) && $_POST["color"]==NULL && isset($_POST["battery"]) && isset($_POST["ram"]) && $_POST["storage"]==NULL) {
  $sql = "SELECT * FROM electronic_products e INNER JOIN electronic_products_stores ep 
  ON e.e_id = ep.electronics_products_id
  INNER JOIN stores_address sa ON sa.branch_id = ep.store_branch_id WHERE sub_id = 1 AND brand = '$mobile_brand' AND price BETWEEN '$low' AND '$high' AND battery BETWEEN '$b_low' AND '$b_high' AND ram = '$mobile_RAM'";
}
...
if (isset($_POST["brand"]) && $_POST["price"]==NULL && isset($_POST["color"]) && isset($_POST["battery"]) && isset($_POST["ram"]) && $_POST["storage"]==NULL) {
  $sql = "SELECT * FROM electronic_products e INNER JOIN electronic_products_stores ep 
  ON e.e_id = ep.electronics_products_id
  INNER JOIN stores_address sa ON sa.branch_id = ep.store_branch_id WHERE sub_id = 1 AND brand = '$mobile_brand' AND color = '$mobile_color' AND battery BETWEEN '$b_low' AND '$b_high' AND ram = '$mobile_RAM'";
}
...
if ($_POST["brand"]==NULL && isset($_POST["price"]) && isset($_POST["color"]) && isset($_POST["battery"]) && isset($_POST["ram"]) && $_POST["storage"]==NULL) {
  $sql = "SELECT * FROM electronic_products e INNER JOIN electronic_products_stores ep 
  ON e.e_id = ep.electronics_products_id
  INNER JOIN stores_address sa ON sa.branch_id = ep.store_branch_id WHERE sub_id = 1 AND price BETWEEN '$low' AND '$high' AND color = '$mobile_color' AND battery BETWEEN '$b_low' AND '$b_high' AND ram = '$mobile_RAM'";
}
...
if (isset($_POST["brand"]) && isset($_POST["price"]) && isset($_POST["color"]) && $_POST["battery"]==NULL && $_POST["ram"]==NULL && isset($_POST["storage"])) {
  $sql = "SELECT * FROM electronic_products e INNER JOIN electronic_products_stores ep 
  ON e.e_id = ep.electronics_products_id
  INNER JOIN stores_address sa ON sa.branch_id = ep.store_branch_id WHERE sub_id = 1 AND brand = '$mobile_brand' AND price BETWEEN '$low' AND '$high' AND color = '$mobile_color' AND storage = '$mobile_STORAGE'";
}
...
if (isset($_POST["brand"]) && isset($_POST["price"]) && $_POST["color"]==NULL && isset($_POST["battery"]) && $_POST["ram"]==NULL && isset($_POST["storage"])) {
  $sql = "SELECT * FROM electronic_products e INNER JOIN electronic_products_stores ep 
  ON e.e_id = ep.electronics_products_id
  INNER JOIN stores_address sa ON sa.branch_id = ep.store_branch_id WHERE sub_id = 1 AND brand = '$mobile_brand' AND price BETWEEN '$low' AND '$high' AND battery BETWEEN '$b_low' AND '$b_high' AND storage = '$mobile_STORAGE'";
}
...
if (isset($_POST["brand"]) && $_POST["price"]==NULL && isset($_POST["color"]) && isset($_POST["battery"]) && $_POST["ram"]==NULL && isset($_POST["storage"])) {
  $sql = "SELECT * FROM electronic_products e INNER JOIN electronic_products_stores ep 
  ON e.e_id = ep.electronics_products_id
  INNER JOIN stores_address sa ON sa.branch_id = ep.store_branch_id WHERE sub_id = 1 AND brand = '$mobile_brand' AND color = '$mobile_color' AND battery BETWEEN '$b_low' AND '$b_high' AND storage = '$mobile_STORAGE'";
}
...
if ($_POST["brand"]==NULL && isset($_POST["price"]) && isset($_POST["color"]) && isset($_POST["battery"]) && $_POST["ram"]==NULL && isset($_POST["storage"])) {
  $sql = "SELECT * FROM electronic_products e INNER JOIN electronic_products_stores ep 
  ON e.e_id = ep.electronics_products_id
  INNER JOIN stores_address sa ON sa.branch_id = ep.store_branch_id WHERE sub_id = 1 AND price BETWEEN '$low' AND '$high' AND color = '$mobile_color' AND battery BETWEEN '$b_low' AND '$b_high' AND storage = '$mobile_STORAGE'";
}
...
if (isset($_POST["brand"]) && isset($_POST["price"]) && $_POST["color"]==NULL && $_POST["battery"]==NULL && isset($_POST["ram"]) && isset($_POST["storage"])) {
  $sql = "SELECT * FROM electronic_products e INNER JOIN electronic_products_stores ep 
  ON e.e_id = ep.electronics_products_id
  INNER JOIN stores_address sa ON sa.branch_id = ep.store_branch_id WHERE sub_id = 1 AND brand = '$mobile_brand' AND price BETWEEN '$low' AND '$high' AND ram = '$mobile_RAM' AND storage = '$mobile_STORAGE'";
}
...
if (isset($_POST["brand"]) && $_POST["price"]==NULL && isset($_POST["color"]) && $_POST["battery"]==NULL && isset($_POST["ram"]) && isset($_POST["storage"])) {
  $sql = "SELECT * FROM electronic_products e INNER JOIN electronic_products_stores ep 
  ON e.e_id = ep.electronics_products_id
  INNER JOIN stores_address sa ON sa.branch_id = ep.store_branch_id WHERE sub_id = 1 AND brand = '$mobile_brand' AND color = '$mobile_color' AND ram = '$mobile_RAM' AND storage = '$mobile_STORAGE'";
}
...
if ($_POST["brand"]==NULL && isset($_POST["price"]) && isset($_POST["color"]) && $_POST["battery"]==NULL && isset($_POST["ram"]) && isset($_POST["storage"])) {
  $sql = "SELECT * FROM electronic_products e INNER JOIN electronic_products_stores ep 
  ON e.e_id = ep.electronics_products_id
  INNER JOIN stores_address sa ON sa.branch_id = ep.store_branch_id WHERE sub_id = 1 AND price BETWEEN '$low' AND '$high' AND color = '$mobile_color' AND ram = '$mobile_RAM' AND storage = '$mobile_STORAGE'";
}
...
if (isset($_POST["brand"]) && $_POST["price"]==NULL && $_POST["color"]==NULL && isset($_POST["battery"]) && isset($_POST["ram"]) && isset($_POST["storage"])) {
  $sql = "SELECT * FROM electronic_products e INNER JOIN electronic_products_stores ep 
  ON e.e_id = ep.electronics_products_id
  INNER JOIN stores_address sa ON sa.branch_id = ep.store_branch_id WHERE sub_id = 1 AND brand = '$mobile_brand' AND battery BETWEEN '$b_low' AND '$b_high' AND ram = '$mobile_RAM' AND storage = '$mobile_STORAGE'";
}
...
if ($_POST["brand"]==NULL && $_POST["price"]==NULL && isset($_POST["color"]) && isset($_POST["battery"]) && isset($_POST["ram"]) && isset($_POST["storage"])) {
  $sql = "SELECT * FROM electronic_products e INNER JOIN electronic_products_stores ep 
  ON e.e_id = ep.electronics_products_id
  INNER JOIN stores_address sa ON sa.branch_id = ep.store_branch_id WHERE sub_id = 1 AND color = '$mobile_color' AND battery BETWEEN '$b_low' AND '$b_high' AND ram = '$mobile_RAM' AND storage = '$mobile_STORAGE'";
}
...
if (isset($_POST["brand"]) && isset($_POST["price"]) && isset($_POST["color"]) && $_POST["battery"]==NULL && $_POST["ram"]==NULL && $_POST["storage"]==NULL ) {
  $sql = "SELECT * FROM electronic_products e INNER JOIN electronic_products_stores ep 
  ON e.e_id = ep.electronics_products_id
  INNER JOIN stores_address sa ON sa.branch_id = ep.store_branch_id WHERE sub_id = 1 AND brand = '$mobile_brand' AND price BETWEEN '$low' AND '$high' AND color = '$mobile_color'";
}
...
if (isset($_POST["brand"]) && isset($_POST["price"]) && $_POST["color"]==NULL && isset($_POST["battery"]) && $_POST["ram"]==NULL && $_POST["storage"]==NULL) {
  $sql = "SELECT * FROM electronic_products e INNER JOIN electronic_products_stores ep 
  ON e.e_id = ep.electronics_products_id
  INNER JOIN stores_address sa ON sa.branch_id = ep.store_branch_id WHERE sub_id = 1 AND brand = '$mobile_brand' AND price BETWEEN '$low' AND '$high' AND battery BETWEEN '$b_low' AND '$b_high'";
}
...
if (isset($_POST["brand"]) && $_POST["price"]==NULL && isset($_POST["color"]) && isset($_POST["battery"]) && $_POST["ram"]==NULL && $_POST["storage"]==NULL) {
  $sql = "SELECT * FROM electronic_products e INNER JOIN electronic_products_stores ep 
  ON e.e_id = ep.electronics_products_id
  INNER JOIN stores_address sa ON sa.branch_id = ep.store_branch_id WHERE sub_id = 1 AND brand = '$mobile_brand' AND color = '$mobile_color' AND battery BETWEEN '$b_low' AND '$b_high'";
}
...
if ($_POST["brand"]==NULL && isset($_POST["price"]) && isset($_POST["color"]) && isset($_POST["battery"]) && $_POST["ram"]==NULL && $_POST["storage"]==NULL) {
  $sql = "SELECT * FROM electronic_products e INNER JOIN electronic_products_stores ep 
  ON e.e_id = ep.electronics_products_id
  INNER JOIN stores_address sa ON sa.branch_id = ep.store_branch_id WHERE sub_id = 1 AND price BETWEEN '$low' AND '$high' AND color = '$mobile_color' AND battery BETWEEN '$b_low' AND '$b_high'";
}
...
if (isset($_POST["brand"]) && isset($_POST["price"]) && $_POST["color"]==NULL && $_POST["battery"]==NULL && $_POST["ram"]==NULL && isset($_POST["storage"])) {
  $sql = "SELECT * FROM electronic_products e INNER JOIN electronic_products_stores ep 
  ON e.e_id = ep.electronics_products_id
  INNER JOIN stores_address sa ON sa.branch_id = ep.store_branch_id WHERE sub_id = 1 AND brand = '$mobile_brand' AND price BETWEEN '$low' AND '$high' AND storage = '$mobile_STORAGE'";
}
...
if (isset($_POST["brand"]) && $_POST["price"]==NULL && isset($_POST["color"]) && $_POST["battery"]==NULL && $_POST["ram"]==NULL && isset($_POST["storage"])) {
  $sql = "SELECT * FROM electronic_products e INNER JOIN electronic_products_stores ep 
  ON e.e_id = ep.electronics_products_id
  INNER JOIN stores_address sa ON sa.branch_id = ep.store_branch_id WHERE sub_id = 1 AND brand = '$mobile_brand' AND color = '$mobile_color' AND storage = '$mobile_STORAGE'";
}
...
if ($_POST["brand"]==NULL && isset($_POST["price"]) && isset($_POST["color"]) && $_POST["battery"]==NULL && $_POST["ram"]==NULL && isset($_POST["storage"])) {
  $sql = "SELECT * FROM electronic_products e INNER JOIN electronic_products_stores ep 
  ON e.e_id = ep.electronics_products_id
  INNER JOIN stores_address sa ON sa.branch_id = ep.store_branch_id WHERE sub_id = 1 AND price BETWEEN '$low' AND '$high' AND color = '$mobile_color' AND storage = '$mobile_STORAGE'";
}
...
if (isset($_POST["brand"]) && $_POST["price"]==NULL && $_POST["color"]==NULL && $_POST["battery"]==NULL && isset($_POST["ram"]) && isset($_POST["storage"])) {
  $sql = "SELECT * FROM electronic_products e INNER JOIN electronic_products_stores ep 
  ON e.e_id = ep.electronics_products_id
  INNER JOIN stores_address sa ON sa.branch_id = ep.store_branch_id WHERE sub_id = 1 AND brand = '$mobile_brand' AND ram = '$mobile_RAM' AND storage = '$mobile_STORAGE'";
}
...
if (isset($_POST["brand"]) && isset($_POST["price"]) && $_POST["color"]==NULL && $_POST["battery"]==NULL && isset($_POST["ram"]) && $_POST["storage"]==NULL) {
  $sql = "SELECT * FROM electronic_products e INNER JOIN electronic_products_stores ep 
  ON e.e_id = ep.electronics_products_id
  INNER JOIN stores_address sa ON sa.branch_id = ep.store_branch_id WHERE sub_id = 1 AND brand = '$mobile_brand' AND price BETWEEN '$low' AND '$high' AND ram = '$mobile_RAM'";
}
...
if ($_POST["brand"]==NULL && isset($_POST["price"]) && $_POST["color"]==NULL && $_POST["battery"]==NULL && isset($_POST["ram"]) && isset($_POST["storage"])) {
  $sql = "SELECT * FROM electronic_products e INNER JOIN electronic_products_stores ep 
  ON e.e_id = ep.electronics_products_id
  INNER JOIN stores_address sa ON sa.branch_id = ep.store_branch_id WHERE sub_id = 1 AND price BETWEEN '$low' AND '$high' AND ram = '$mobile_RAM' AND storage = '$mobile_STORAGE'";
}
...
if ($_POST["brand"]==NULL && $_POST["price"]==NULL && $_POST["color"]==NULL && isset($_POST["battery"]) && isset($_POST["ram"]) && isset($_POST["storage"])) {
  $sql = "SELECT * FROM electronic_products e INNER JOIN electronic_products_stores ep 
  ON e.e_id = ep.electronics_products_id
  INNER JOIN stores_address sa ON sa.branch_id = ep.store_branch_id WHERE sub_id = 1 AND battery BETWEEN '$b_low' AND '$b_high' AND ram = '$mobile_RAM' AND storage = '$mobile_STORAGE'";
}
...
if (isset($_POST["brand"]) && $_POST["price"]==NULL && $_POST["color"]==NULL && isset($_POST["battery"]) && $_POST["ram"]==NULL && isset($_POST["storage"])) {
  $sql = "SELECT * FROM electronic_products e INNER JOIN electronic_products_stores ep 
  ON e.e_id = ep.electronics_products_id
  INNER JOIN stores_address sa ON sa.branch_id = ep.store_branch_id WHERE sub_id = 1 AND brand = '$mobile_brand' AND battery BETWEEN '$b_low' AND '$b_high' AND storage = '$mobile_STORAGE'";
}
...
if (isset($_POST["brand"]) && $_POST["price"]==NULL && $_POST["color"]==NULL && isset($_POST["battery"]) && isset($_POST["ram"]) && $_POST["storage"]==NULL) {
  $sql = "SELECT * FROM electronic_products e INNER JOIN electronic_products_stores ep 
  ON e.e_id = ep.electronics_products_id
  INNER JOIN stores_address sa ON sa.branch_id = ep.store_branch_id WHERE sub_id = 1 AND brand = '$mobile_brand' AND battery BETWEEN '$b_low' AND '$b_high' AND ram = '$mobile_RAM'";
}
...
if (isset($_POST["brand"]) && isset($_POST["price"]) && $_POST["color"]==NULL && $_POST["battery"]==NULL && $_POST["ram"]==NULL && $_POST["storage"]==NULL) {
  $sql = "SELECT * FROM electronic_products e INNER JOIN electronic_products_stores ep 
  ON e.e_id = ep.electronics_products_id
  INNER JOIN stores_address sa ON sa.branch_id = ep.store_branch_id WHERE sub_id = 1 AND brand = '$mobile_brand' AND price BETWEEN '$low' AND '$high'";
}
...
if (isset($_POST["brand"]) && $_POST["price"]==NULL && isset($_POST["color"]) && $_POST["battery"]==NULL && $_POST["ram"]==NULL && $_POST["storage"]==NULL) {
  $sql = "SELECT * FROM electronic_products e INNER JOIN electronic_products_stores ep 
  ON e.e_id = ep.electronics_products_id
  INNER JOIN stores_address sa ON sa.branch_id = ep.store_branch_id WHERE sub_id = 1 AND brand = '$mobile_brand' AND color = '$mobile_color'";
}
...
if ($_POST["brand"]==NULL && isset($_POST["price"]) && isset($_POST["color"]) && $_POST["battery"]==NULL && $_POST["ram"]==NULL && $_POST["storage"]==NULL) {
  $sql = "SELECT * FROM electronic_products e INNER JOIN electronic_products_stores ep 
  ON e.e_id = ep.electronics_products_id
  INNER JOIN stores_address sa ON sa.branch_id = ep.store_branch_idWHERE sub_id = 1 AND price BETWEEN '$low' AND '$high' AND color = '$mobile_color'";
}
...
if (isset($_POST["brand"]) && $_POST["price"]==NULL && $_POST["color"]==NULL && $_POST["battery"]==NULL && $_POST["ram"]==NULL && isset($_POST["storage"])) {
  $sql = "SELECT * FROM electronic_products e INNER JOIN electronic_products_stores ep 
  ON e.e_id = ep.electronics_products_id
  INNER JOIN stores_address sa ON sa.branch_id = ep.store_branch_id WHERE sub_id = 1 AND brand = '$mobile_brand' AND storage = '$mobile_STORAGE'";
}
...
if ($_POST["brand"]==NULL && isset($_POST["price"]) && $_POST["color"]==NULL && $_POST["battery"]==NULL && $_POST["ram"]==NULL && isset($_POST["storage"])) {
  $sql = "SELECT * FROM electronic_products e INNER JOIN electronic_products_stores ep 
  ON e.e_id = ep.electronics_products_id
  INNER JOIN stores_address sa ON sa.branch_id = ep.store_branch_id WHERE sub_id = 1 AND price BETWEEN '$low' AND '$high' AND storage = '$mobile_STORAGE'";
}
...
if (isset($_POST["brand"]) && $_POST["price"]==NULL && $_POST["color"]==NULL && $_POST["battery"]==NULL && isset($_POST["ram"]) && $_POST["storage"]==NULL) {
  $sql = "SELECT * FROM electronic_products e INNER JOIN electronic_products_stores ep 
  ON e.e_id = ep.electronics_products_id
  INNER JOIN stores_address sa ON sa.branch_id = ep.store_branch_id WHERE sub_id = 1 AND brand = '$mobile_brand' AND ram = '$mobile_RAM'";
}
...
if ($_POST["brand"]==NULL && $_POST["price"]==NULL && $_POST["color"]==NULL && $_POST["battery"]==NULL && isset($_POST["ram"]) && isset($_POST["storage"])) {
  $sql = "SELECT * FROM electronic_products e INNER JOIN electronic_products_stores ep 
  ON e.e_id = ep.electronics_products_id
  INNER JOIN stores_address sa ON sa.branch_id = ep.store_branch_id WHERE sub_id = 1 AND ram = '$mobile_RAM' AND storage = '$mobile_STORAGE'";
}
...
if ($_POST["brand"]==NULL && $_POST["price"]==NULL && $_POST["color"]==NULL && isset($_POST["battery"]) && $_POST["ram"]==NULL && isset($_POST["storage"])) {
  $sql = "SELECT * FROM electronic_products e INNER JOIN electronic_products_stores ep 
  ON e.e_id = ep.electronics_products_id
  INNER JOIN stores_address sa ON sa.branch_id = ep.store_branch_id WHERE sub_id = 1 AND battery BETWEEN '$b_low' AND '$b_high' AND storage = '$mobile_STORAGE'";
}
...
if ($_POST["brand"]==NULL && $_POST["price"]==NULL && $_POST["color"]==NULL && isset($_POST["battery"]) && isset($_POST["ram"]) && $_POST["storage"]==NULL) {
  $sql = "SELECT * FROM electronic_products e INNER JOIN electronic_products_stores ep 
  ON e.e_id = ep.electronics_products_id
  INNER JOIN stores_address sa ON sa.branch_id = ep.store_branch_idWHERE sub_id = 1 AND battery BETWEEN '$b_low' AND '$b_high' AND ram = '$mobile_RAM'";
}
...
if (isset($_POST["brand"]) && $_POST["price"]==NULL && $_POST["color"]==NULL && $_POST["battery"]==NULL && $_POST["ram"]==NULL && $_POST["storage"]==NULL) {
  $sql = "SELECT * FROM electronic_products e INNER JOIN electronic_products_stores ep 
  ON e.e_id = ep.electronics_products_id
  INNER JOIN stores_address sa ON sa.branch_id = ep.store_branch_idWHERE sub_id = 1 AND brand = '$mobile_brand'";
}
...
if ($_POST["brand"]==NULL && isset($_POST["price"]) && $_POST["color"]==NULL && $_POST["battery"]==NULL && $_POST["ram"]==NULL && $_POST["storage"]==NULL) {
  $sql = "SELECT * FROM electronic_products e INNER JOIN electronic_products_stores ep 
  ON e.e_id = ep.electronics_products_id
  INNER JOIN stores_address sa ON sa.branch_id = ep.store_branch_id WHERE sub_id = 1 AND price BETWEEN $low AND $high";
}
...
if ($_POST["brand"]==NULL && $_POST["price"]==NULL && $_POST["color"]==NULL && $_POST["battery"]==NULL && $_POST["ram"]==NULL && isset($_POST["storage"])) {
  $sql = "SELECT * FROM electronic_products e INNER JOIN electronic_products_stores ep 
  ON e.e_id = ep.electronics_products_id
  INNER JOIN stores_address sa ON sa.branch_id = ep.store_branch_id WHERE sub_id = 1 AND storage = '$mobile_STORAGE'";
}
...
if ($_POST["brand"]==NULL && $_POST["price"]==NULL && isset($_POST["color"]) && $_POST["battery"]==NULL && $_POST["ram"]==NULL && $_POST["storage"]==NULL) {
  $sql = "SELECT * FROM electronic_products e INNER JOIN electronic_products_stores ep 
  ON e.e_id = ep.electronics_products_id
  INNER JOIN stores_address sa ON sa.branch_id = ep.store_branch_id WHERE sub_id = 1 AND color = '$mobile_color'";
}
...
if ($_POST["brand"]==NULL && $_POST["price"]==NULL && $_POST["color"]==NULL && $_POST["battery"]==NULL && isset($_POST["ram"]) && $_POST["storage"]==NULL) {
  $sql = "SELECT * FROM electronic_products e INNER JOIN electronic_products_stores ep 
  ON e.e_id = ep.electronics_products_id
  INNER JOIN stores_address sa ON sa.branch_id = ep.store_branch_idWHERE sub_id = 1 AND ram = '$mobile_RAM'";
}
...
if ($_POST["brand"]==NULL && $_POST["price"]==NULL && $_POST["color"]==NULL && isset($_POST["battery"]) && $_POST["ram"]==NULL && $_POST["storage"]==NULL) {
  $sql = "SELECT * FROM electronic_products e INNER JOIN electronic_products_stores ep 
  ON e.e_id = ep.electronics_products_id
  INNER JOIN stores_address sa ON sa.branch_id = ep.store_branch_id WHERE sub_id = 1 AND battery BETWEEN '$b_low' AND '$b_high'";
}
...
if ($_POST["brand"]==NULL && $_POST["price"]==NULL && $_POST["color"]==NULL && $_POST["battery"]==NULL && $_POST["ram"]==NULL && $_POST["storage"]==NULL && isset($_POST["gov"])) {
  $sql = "SELECT * FROM electronic_products e INNER JOIN electronic_products_stores ep 
          ...
          WHERE sub_id = 1 AND branch_location = '$gov'";
}
...
if ($_POST["brand"]==NULL && $_POST["price"]==NULL && $_POST["color"]==NULL && $_POST["battery"]==NULL && $_POST["ram"]==NULL && $_POST["storage"]==NULL && $_POST["gov"]==NULL) {
  $sql = "SELECT * FROM electronic_products e INNER JOIN electronic_products_stores ep 
  ON e.e_id = ep.electronics_products_id
  INNER JOIN stores_address sa ON sa.branch_id = ep.store_branch_id WHERE sub_id = 1";
}
              ...
              <div class="options">
                      ...
                      <div class="box border-bottom">
                        ...
                        <div class="inner-box2" class="collapse mt-2 mr-1">
                            ...
                            <div class="my-1"> <label class="tick">Xiaomi <input type="radio" name="brand" value="mi"> <span class="check"></span> </label> </div> 
                            <div class="my-1"> <label class="tick">Infinix <input type="radio" name="brand" value="infinix"> <span class="check"></span> </label> </div> 
