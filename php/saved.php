...
<p>
      ...
      <form action="" method="post"  id="submitCardId"> 
      <input type="hidden" name="c_id" id="cardId" value="<?php echo $row['card_id']; ?>">
      <input type="submit" name="saved" value="Remove"  class="btn btn-outline-warning"> 
      </form>
  </div>
</div>
